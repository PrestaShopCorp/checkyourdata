...
<fieldset class="space">
    ...
    <h3>{l s='Custom setting' mod='checkyourdata'}</h3>
    <p>{l s='Took different needs into account in the configuring your account' mod='checkyourdata'}</p>

    <h3>{l s='Reactive support at your service' mod='checkyourdata'}</h3>
    <p>
        {l s='We will reply in 48 hours' mod='checkyourdata'}<br/>
